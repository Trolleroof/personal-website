...
const Projects: React.FC = () => (
  <div className="panel" id="projects">
    <div className="panel-header"><span className="ph-icon">◆</span> Nikhi Prabhu's Latest Work <a href="#" style={{ color: '#ffd0ee', fontSize: 10, marginLeft: 8, fontWeight: 400 }}>(view more)</a></div>
